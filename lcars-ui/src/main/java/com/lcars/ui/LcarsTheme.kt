...
data class LcarsColors(
    ...
    val framePrimary: Color = lightBlue,
    val frameSecondary: Color = violet,
    val commandPrimary: Color = lightBlue,
    val commandSecondary: Color = violet,
    val commandInactive: Color = a6,
    val activeAccent: Color = tacticalGreen,
    val inactiveAccent: Color = a2,
    val subHighlight: Color = a2,
    val meterInactive: Color = a7,
    val sensorBar: Color = a8,
    val readoutAccent: Color = a1,
    // Legacy weather aliases kept while the demo migrates to generic roles.
    val weatherFrame: Color = framePrimary,
    val weatherBtnStyle: Color = commandPrimary,
    val weatherBtnSecondary: Color = commandSecondary,
    val weatherBtnInactive: Color = commandInactive,
    val weatherActiveAccent: Color = activeAccent,
    val weatherInactiveAccent: Color = inactiveAccent,
    val weatherSubHighlight: Color = subHighlight,
    val weatherMeterInactive: Color = meterInactive,
    val weatherSensorBar: Color = sensorBar,
    val weatherSensorLabel: Color = readoutAccent,
)

...
fun LcarsInspectBracket(
    ...
    val marker by if (running && LcarsTheme.motionMode == LcarsMotionMode.System) {
        ...
        transition.animateFloat(
            ...
            label = "LcarsInspectBracketMarkerStatic",
        )
    }
...
fun LcarsTargetScanner(
    ...
    Canvas(modifier = modifier.fillMaxSize()) {
        ...
        repeat(3) { ring ->
            ...
            val alpha = (1f - localProgress).coerceIn(0.08f, 0.45f)
